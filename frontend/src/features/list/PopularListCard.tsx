...
interface Props {
  list: PopularList;
  // Verilirse kart (poster + başlık) bu adrese bağlanır (ör. liste detay sayfası).
  // Kullanıcı linki iç içe <a> olmaması için ayrı tutulur.
  to?: string;
}

// Popüler liste kartı bileşeni
// Ana sayfada ve liste sayfasında kullanıcıların popüler listelerini gösterir
